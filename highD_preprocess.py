...
SEARCH_PATH = '~/dd8'  # Folder containing original data
INPUT_LENGTH = 2
PRED_HORIZON = 5
N_IN_FEATURES = 9
N_OUT_FEATURES = 7
...
if __name__ == "__main__":
    ...
    for r_id in rec_ids:
        ...
        rec_meta = pd.read_csv(f'{SEARCH_PATH}/hdata/{r_id}_recordingMeta.csv')
        t_meta = pd.read_csv(f'{SEARCH_PATH}/hdata/{r_id}_tracksMeta.csv')
        tracks = pd.read_csv(f'{SEARCH_PATH}/hdata/{r_id}_tracks.csv', engine='pyarrow')
